// Code generated by scripts/generate_testing_client.sh. DO NOT EDIT.
...
type testClientMocks struct {
	...
	MockContainerRegistryTagProtectionRules *MockContainerRegistryTagProtectionRulesServiceInterface
...
func newTestClientWithCtrl(ctrl *gomock.Controller, options ...gitlab.ClientOptionFunc) *TestClient {
	...
	mockContainerRegistryTagProtectionRules := NewMockContainerRegistryTagProtectionRulesServiceInterface(ctrl)
	...
	c := &gitlab.Client{
		...
		ContainerRegistryTagProtectionRules: mockContainerRegistryTagProtectionRules,
	...
	return &TestClient{
		...
		testClientMocks: &testClientMocks{
			...
			MockContainerRegistryTagProtectionRules: mockContainerRegistryTagProtectionRules,
