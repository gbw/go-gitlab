...
// Source: gitlab.com/gitlab-org/api/client-go/v2 (interfaces: DockerfileTemplatesServiceInterface)
//
// Generated by this command:
//
//	mockgen -typed -destination=dockerfile_templates_mock.go -write_package_comment=false -package=testing gitlab.com/gitlab-org/api/client-go/v2 DockerfileTemplatesServiceInterface
//
