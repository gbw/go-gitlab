...
//
//	mockgen -typed -destination=snippet_repository_storage_move_mock.go -package=testing gitlab.com/gitlab-org/api/client-go SnippetRepositoryStorageMoveServiceInterface
//
