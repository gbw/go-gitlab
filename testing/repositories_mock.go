...
// StreamBlob mocks base method.
func (m *MockRepositoriesServiceInterface) StreamBlob(pid any, sha string, w io.Writer, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{pid, sha, w}
	for _, a := range options {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "StreamBlob", varargs...)
	ret0, _ := ret[0].(*gitlab.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// StreamBlob indicates an expected call of StreamBlob.
func (mr *MockRepositoriesServiceInterfaceMockRecorder) StreamBlob(pid, sha, w any, options ...any) *MockRepositoriesServiceInterfaceStreamBlobCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{pid, sha, w}, options...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StreamBlob", reflect.TypeOf((*MockRepositoriesServiceInterface)(nil).StreamBlob), varargs...)
	return &MockRepositoriesServiceInterfaceStreamBlobCall{Call: call}
}

// MockRepositoriesServiceInterfaceStreamBlobCall wrap *gomock.Call
type MockRepositoriesServiceInterfaceStreamBlobCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockRepositoriesServiceInterfaceStreamBlobCall) Return(arg0 *gitlab.Response, arg1 error) *MockRepositoriesServiceInterfaceStreamBlobCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRepositoriesServiceInterfaceStreamBlobCall) Do(f func(any, string, io.Writer, ...gitlab.RequestOptionFunc) (*gitlab.Response, error)) *MockRepositoriesServiceInterfaceStreamBlobCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRepositoriesServiceInterfaceStreamBlobCall) DoAndReturn(f func(any, string, io.Writer, ...gitlab.RequestOptionFunc) (*gitlab.Response, error)) *MockRepositoriesServiceInterfaceStreamBlobCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// StreamRawBlobContent mocks base method.
func (m *MockRepositoriesServiceInterface) StreamRawBlobContent(pid any, sha string, w io.Writer, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{pid, sha, w}
	for _, a := range options {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "StreamRawBlobContent", varargs...)
	ret0, _ := ret[0].(*gitlab.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// StreamRawBlobContent indicates an expected call of StreamRawBlobContent.
func (mr *MockRepositoriesServiceInterfaceMockRecorder) StreamRawBlobContent(pid, sha, w any, options ...any) *MockRepositoriesServiceInterfaceStreamRawBlobContentCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{pid, sha, w}, options...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StreamRawBlobContent", reflect.TypeOf((*MockRepositoriesServiceInterface)(nil).StreamRawBlobContent), varargs...)
	return &MockRepositoriesServiceInterfaceStreamRawBlobContentCall{Call: call}
}

// MockRepositoriesServiceInterfaceStreamRawBlobContentCall wrap *gomock.Call
type MockRepositoriesServiceInterfaceStreamRawBlobContentCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockRepositoriesServiceInterfaceStreamRawBlobContentCall) Return(arg0 *gitlab.Response, arg1 error) *MockRepositoriesServiceInterfaceStreamRawBlobContentCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRepositoriesServiceInterfaceStreamRawBlobContentCall) Do(f func(any, string, io.Writer, ...gitlab.RequestOptionFunc) (*gitlab.Response, error)) *MockRepositoriesServiceInterfaceStreamRawBlobContentCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRepositoriesServiceInterfaceStreamRawBlobContentCall) DoAndReturn(f func(any, string, io.Writer, ...gitlab.RequestOptionFunc) (*gitlab.Response, error)) *MockRepositoriesServiceInterfaceStreamRawBlobContentCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
