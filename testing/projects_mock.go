...
func (m *MockProjectsServiceInterface) UploadFile(pid any, content io.Reader, filename string, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectFile, *gitlab.Response, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProjectsServiceInterfaceMockRecorder) UploadFile(pid, content, filename any, options ...any) *MockProjectsServiceInterfaceUploadFileCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{pid, content, filename}, options...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UploadFile", reflect.TypeOf((*MockProjectsServiceInterface)(nil).UploadFile), varargs...)
	return &MockProjectsServiceInterfaceUploadFileCall{Call: call}
}

// MockProjectsServiceInterfaceUploadFileCall wrap *gomock.Call
type MockProjectsServiceInterfaceUploadFileCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockProjectsServiceInterfaceUploadFileCall) Return(arg0 *gitlab.ProjectFile, arg1 *gitlab.Response, arg2 error) *MockProjectsServiceInterfaceUploadFileCall {
	c.Call = c.Call.Return(arg0, arg1, arg2)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockProjectsServiceInterfaceUploadFileCall) Do(f func(any, io.Reader, string, ...gitlab.RequestOptionFunc) (*gitlab.ProjectFile, *gitlab.Response, error)) *MockProjectsServiceInterfaceUploadFileCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockProjectsServiceInterfaceUploadFileCall) DoAndReturn(f func(any, io.Reader, string, ...gitlab.RequestOptionFunc) (*gitlab.ProjectFile, *gitlab.Response, error)) *MockProjectsServiceInterfaceUploadFileCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
