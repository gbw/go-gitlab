...
// Source: gitlab.com/gitlab-org/api/client-go/v2 (interfaces: ProjectsServiceInterface)
//
// Generated by this command:
//
//	mockgen -typed -destination=projects_mock.go -write_package_comment=false -package=testing gitlab.com/gitlab-org/api/client-go/v2 ProjectsServiceInterface
//
