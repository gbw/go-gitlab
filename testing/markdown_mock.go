...
// Source: gitlab.com/gitlab-org/api/client-go/v2 (interfaces: MarkdownServiceInterface)
//
// Generated by this command:
//
//	mockgen -typed -destination=markdown_mock.go -write_package_comment=false -package=testing gitlab.com/gitlab-org/api/client-go/v2 MarkdownServiceInterface
//
