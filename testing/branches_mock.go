...
func (m *MockBranchesServiceInterface) ProtectBranch(pid any, branch string, opts *gitlab.ProtectBranchOptions, options ...gitlab.RequestOptionFunc) (*gitlab.Branch, *gitlab.Response, error) {
	m.ctrl.T.Helper()
...
func (mr *MockBranchesServiceInterfaceMockRecorder) ProtectBranch(pid, branch, opts any, options ...any) *MockBranchesServiceInterfaceProtectBranchCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{pid, branch, opts}, options...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProtectBranch", reflect.TypeOf((*MockBranchesServiceInterface)(nil).ProtectBranch), varargs...)
	return &MockBranchesServiceInterfaceProtectBranchCall{Call: call}
}

// MockBranchesServiceInterfaceProtectBranchCall wrap *gomock.Call
type MockBranchesServiceInterfaceProtectBranchCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockBranchesServiceInterfaceProtectBranchCall) Return(arg0 *gitlab.Branch, arg1 *gitlab.Response, arg2 error) *MockBranchesServiceInterfaceProtectBranchCall {
	c.Call = c.Call.Return(arg0, arg1, arg2)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockBranchesServiceInterfaceProtectBranchCall) Do(f func(any, string, *gitlab.ProtectBranchOptions, ...gitlab.RequestOptionFunc) (*gitlab.Branch, *gitlab.Response, error)) *MockBranchesServiceInterfaceProtectBranchCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockBranchesServiceInterfaceProtectBranchCall) DoAndReturn(f func(any, string, *gitlab.ProtectBranchOptions, ...gitlab.RequestOptionFunc) (*gitlab.Branch, *gitlab.Response, error)) *MockBranchesServiceInterfaceProtectBranchCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// UnprotectBranch mocks base method.
func (m *MockBranchesServiceInterface) UnprotectBranch(pid any, branch string, options ...gitlab.RequestOptionFunc) (*gitlab.Branch, *gitlab.Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{pid, branch}
	for _, a := range options {
		varargs = append(varargs, a)
...
func (mr *MockBranchesServiceInterfaceMockRecorder) UnprotectBranch(pid, branch any, options ...any) *MockBranchesServiceInterfaceUnprotectBranchCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{pid, branch}, options...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UnprotectBranch", reflect.TypeOf((*MockBranchesServiceInterface)(nil).UnprotectBranch), varargs...)
	return &MockBranchesServiceInterfaceUnprotectBranchCall{Call: call}
}

// MockBranchesServiceInterfaceUnprotectBranchCall wrap *gomock.Call
type MockBranchesServiceInterfaceUnprotectBranchCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockBranchesServiceInterfaceUnprotectBranchCall) Return(arg0 *gitlab.Branch, arg1 *gitlab.Response, arg2 error) *MockBranchesServiceInterfaceUnprotectBranchCall {
	c.Call = c.Call.Return(arg0, arg1, arg2)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockBranchesServiceInterfaceUnprotectBranchCall) Do(f func(any, string, ...gitlab.RequestOptionFunc) (*gitlab.Branch, *gitlab.Response, error)) *MockBranchesServiceInterfaceUnprotectBranchCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockBranchesServiceInterfaceUnprotectBranchCall) DoAndReturn(f func(any, string, ...gitlab.RequestOptionFunc) (*gitlab.Branch, *gitlab.Response, error)) *MockBranchesServiceInterfaceUnprotectBranchCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
