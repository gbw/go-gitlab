...
// Source: gitlab.com/gitlab-org/api/client-go/v2 (interfaces: SystemHooksServiceInterface)
//
// Generated by this command:
//
//	mockgen -typed -destination=system_hooks_mock.go -write_package_comment=false -package=testing gitlab.com/gitlab-org/api/client-go/v2 SystemHooksServiceInterface
//
