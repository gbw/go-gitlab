...
// Source: gitlab.com/gitlab-org/api/client-go/v2 (interfaces: DependencyProxyServiceInterface)
//
// Generated by this command:
//
//	mockgen -typed -destination=dependency_proxy_mock.go -write_package_comment=false -package=testing gitlab.com/gitlab-org/api/client-go/v2 DependencyProxyServiceInterface
//
