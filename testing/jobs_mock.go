...
// Source: gitlab.com/gitlab-org/api/client-go/v2 (interfaces: JobsServiceInterface)
//
// Generated by this command:
//
//	mockgen -typed -destination=jobs_mock.go -write_package_comment=false -package=testing gitlab.com/gitlab-org/api/client-go/v2 JobsServiceInterface
//
